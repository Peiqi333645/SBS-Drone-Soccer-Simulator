...
> This branch contains the **SBS Drone Soccer Simulator v0.1.0** adaptation.
> See [README_SBS.md](README_SBS.md) for the Chinese setup guide, controls,
> implemented training features, and current limitations.
