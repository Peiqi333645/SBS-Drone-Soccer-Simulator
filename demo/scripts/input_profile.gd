...
var physics := {"mass": 0.42, "gravity": 1.28, "thrust": 1.0, "drag_low": 0.026, "drag_high": 0.070, "turbulence": 0.0, "motor_kv": 2450.0, "voltage": 16.8}
...
func reset_defaults() -> void:
	...
	physics = {"mass":0.42,"gravity":1.28,"thrust":1.0,"drag_low":0.026,"drag_high":0.070,"turbulence":0.0,"motor_kv":2450.0,"voltage":16.8}
